// Copied from https://github.com/rubensworks/DefinitelyTyped/blob/bc12770cd5b8662bbdb8835f4e12f53ed0a30956/types/n3/index.d.ts
//
//
...
declare module "n3" {
  ...
  export interface N3StreamParser
    extends RDF.Stream,
      NodeJS.WritableStream,
      RDF.Sink {
    // TODO: remove following and implement NodeJS.ReadWriteStream when this fix has been merged: https://github.com/DefinitelyTyped/DefinitelyTyped/pull/26373
    // From NodeJS.ReadableStream, which clashes with RDF.Stream
    readable: boolean;
    ...
    resume(): this;
    isPaused(): boolean;
    pipe<T extends NodeJS.WritableStream | RDF.Stream>(
      destination: T,
      options?: { end?: boolean }
    ): T;
  ...
  export namespace Util {
    ...
    function prefix(
      iri: string,
      factory?: RDF.DataFactory
    ): (suffix: string) => RDF.NamedNode;
    function prefixes(
      defaultPrefixes: Prefixes,
      factory?: RDF.DataFactory
    ): (iri: string) => (suffix: string) => RDF.NamedNode;
  }
}
